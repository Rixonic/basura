...
<body
    ...
    <header>
        <div style="display: flex; flex-direction: row;width: 100%; justify-content: space-between;align-items: center;">
            ...
            <div style="display: flex; flex-direction: column; justify-content: flex-end; align-items: end;">
                ...
                <p style="font-size: 9pt; font-weight: bold;">MANTENIMIENTO Y HOTELERIA</p>
    ...
    <main >
        ...
        <table border="1" style="width: auto; align-self: flex-end; margin-right: 10%;">
            <thead>
                <tr style="height: 40px;">
                    <th style="width: 125px;">SERVICIO SOLICITANTE</th>
                    <th style="width: 125px;">SUB SECTOR</th>
                    <th style="width: 125px;">PRIORIDAD DE LA SOLICITUD</th>
                </tr>
            </thead>
            <tbody>
    ...
    <footer style="text-align: center;height: 10px;">
